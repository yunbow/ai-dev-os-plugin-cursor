...
- [ ] `# type: ignore` is not used without a specific error code
...
- [ ] No circular imports
- [ ] Side-effect functions are named with verbs
- [ ] Pure functions are named with nouns/adjectives

## Logging (structlog)
- [ ] Logs are structured (key-value pairs)
- [ ] PII is redacted from log output
- [ ] Request trace IDs are propagated
- [ ] Logs write to stderr
